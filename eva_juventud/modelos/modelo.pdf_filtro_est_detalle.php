...
class pdf_lista_est extends FPDF
{
	...
	function Header()
	{
            ...
            $this->Cell(0,5,'LISTADO DE ESTUDIANTES APROBADOS/REPROBADOS (DETALLE)',0,0,'C');
            $this->Ln(10);
			$this->SetFillColor(169,169,169) ;
            $this->SetTextColor(1);            
            $this->Cell(20,5,"Nac.",1,0,'C',1);
            $this->Cell(30,5,utf8_decode("Cédula"),1,0,'C',1);
            $this->Cell(80,5,"Nombres",1,0,'C',1);
            $this->Cell(80,5,"E.V.A",1,0,'C',1);
            $this->Cell(40,5,"ESTATUS",1,0,'C',1);
            $this->Ln();
