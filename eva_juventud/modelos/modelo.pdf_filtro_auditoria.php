...
class pdf_lista_auditoria extends FPDF
{
	...
	function Header()
	{
            ...
            $this->Cell(0,5,'LISTADO DE AUDITORIA',0,0,'C');
            $this->Ln(10);
			$this->SetFillColor(169,169,169) ;
            $this->SetTextColor(1);
            $this->SetMargins(20, 5 , 10);
	        $this->Cell(40,5,"Secciones",1,0,'C',1);
            $this->Cell(40,5,"Acciones",1,0,'C',1);
            $this->Cell(40,5,"US",1,0,'C',1);
            $this->Cell(30,5,"IP",1,0,'C',1);
