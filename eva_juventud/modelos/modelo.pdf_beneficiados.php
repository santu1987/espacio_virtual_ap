...
class pdf_lista_est extends FPDF
{
	...
	function Header()
	{
            ...
            $this->SetMargins(45, 5 , 10);
            $this->Cell(0,5,'LISTADO DE BENEFICIADOS POR EL SISTEMA DE ESPACIOS VIRTUALES DE APRENDIZAJE',0,0,'C');
            $this->Ln(10);
			$this->SetFillColor(169,169,169) ;
            $this->SetTextColor(1);            
            $this->Cell(60,5,"Estado",1,0,'C',1);
            $this->Cell(60,5,"Municipio",1,0,'C',1);
            $this->Cell(60,5,"Parroquia",1,0,'C',1);
            $this->Cell(30,5,"Beneficiados",1,0,'C',1);
            $this->Ln();
    }
