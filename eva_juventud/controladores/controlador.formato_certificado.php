...
$rs=$obj_cert->consultar_elementos($id_aula,$id_cert,$id_us);
//aula virtual
$aula_virtual=$rs[0][0];
//creo el fondo
...
if($firma_presidente==null)
{
	$firma_presidente="firma_usuario.jpg";
}
$pdf->AliasNbPages();
...
$pdf->Cell(30,5,utf8_decode($rs[0][1]),0,0,'L',0);$pdf->cell(160,5,utf8_decode($rs[0][4]),0,0,'R',0);$pdf->ln();
