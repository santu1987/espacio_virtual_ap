...
function cargar_consulta_fac(offset,limit,actual)
{
	...
	$.ajax({
				url:"./controladores/controlador.visualizar_facilitadores.php",
				data:data,
				type:"POST",
				cache:false,
				error: function()
...
<div id="cuerpo_aula" class="cuerpo_aula">
		<div id="titulo_eva" name="titulo_eva">
			<h1 class="titulo_eva"><i class="fa fa-user" style="padding: 1%;"></i></i> Facilitadores</h1>
		</div>
